...
class StatisticalTester:
    ...
    def describe_result(self, test_result):
         ...
         if p_value < self.alpha:
            return (
            f"از آنجا که مقدار p-value برابر با {p_value:.4f} است و از سطح معناداری "
            f"alpha = {self.alpha} کمتر می‌باشد، فرض صفر رد می‌شود. "
            "بنابراین شواهد آماری معناداری وجود دارد که نشان می‌دهد مقدار متغیر مورد بررسی "
            "در دوره اخیر بیشتر از دوره گذشته است."
        )

         return (
        f"از آنجا که مقدار p-value برابر با {p_value:.4f} است و از سطح معناداری "
        f"alpha = {self.alpha} بزرگ‌تر یا مساوی می‌باشد، فرض صفر رد نمی‌شود. "
        "بنابراین شواهد آماری کافی وجود ندارد که نتیجه بگیریم مقدار متغیر مورد بررسی "
        "در دوره اخیر بیشتر از دوره گذشته است."
    )
